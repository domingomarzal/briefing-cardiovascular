...
CONFIGS = [
 ...
 dict(n="n15", linkfix=_acr(BASE+"/generador/n15_linkfix.json"), jlinks=_acr(BASE+"/generador/n15_jlinks.json"), data=BASE+"/generador/n15_data.json", num="Nº 15", period=("14 al 20 de septiembre de 2026","September 14–20, 2026"), dest="a11", top3=["a1","a6","a16"], acr=_acr(BASE+"/generador/n15_acr.json"), viz=_viz(BASE+"/generador/n15_viz.html"), local="Briefing Cardiovascular_N15", lnum="N15"),
]
import sys as _sys
