...
(function(){
 ...
 (function(){
  ...
  /* Velocidad: por defecto 1,25x en español y 1x en inglés — las voces
     españolas suenan lentas al ritmo neutro. Se guarda por idioma. */
  var vel = 1;
  function velDef(){ return lang() === 'es' ? 1.25 : 1; }
  function leeVel(){
    var v = null;
    try { v = parseFloat(localStorage.getItem('brief-vel-' + lang())); } catch(e){}
    return v || velDef();
  }
  ...
  function montaVel(){
    ...
    sv.addEventListener('change', function(){
      ...
      try { localStorage.setItem('brief-vel-' + lang(), String(vel)); } catch(e){}
