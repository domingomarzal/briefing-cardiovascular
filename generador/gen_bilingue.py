...
CONFIGS = [
 ...
 dict(n="n14", linkfix=_acr(BASE+"/generador/n14_linkfix.json"), data=BASE+"/generador/n14_data.json", num="Nº 14", period=("7 al 13 de septiembre de 2026","September 7–13, 2026"), dest="a30", top3=["a25","a35","a20"], acr=_acr(BASE+"/generador/n14_acr.json"), viz=_viz(BASE+"/generador/n14_viz.html"), local="Briefing Cardiovascular_N14", lnum="N14"),
]
import sys as _sys
