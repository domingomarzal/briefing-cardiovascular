...
<title>Briefing Cardiovascular — N2</title>
<style>
  :root{{
  ...
  <div class="mast">
    <div class="mast-row">
      ...
      <div class="mast-right">
        ...
        <span class="periodo">15 al 21 de junio de 2026</span>
      </div>
    </div>
    ...
    <div class="destacado">
      ...
      <div class="d-grid">
        <div class="d-text">
          ...
          <p>Seguimiento a <b>10 años</b> del ensayo aleatorizado PARTNER 2A en estenosis aórtica grave sintomática de <b>riesgo quirúrgico intermedio</b>: el TAVR balón-expandible (SAPIEN XT) se asoció a mayor mortalidad por cualquier causa (86,1% vs 82,8%; HR 1,13; IC 95% 1,02-1,25) y a más reintervención valvular (6,3% vs 1,6%) que la cirugía, con la diferencia concentrada en el acceso no transfemoral.</p>
          <p class="why"><b>Por qué importa:</b> es el seguimiento <b>aleatorizado más largo</b> que compara TAVR y cirugía en riesgo intermedio. Matiza la durabilidad a muy largo plazo y refuerza el peso de la <b>esperanza de vida y la vía de acceso</b> al elegir entre percutáneo y quirúrgico.</p>
          <div class="jwrap"><a class="j" href="{dest_href}" target="_blank">{dest["journal"]} <span class="go">↗</span></a></div>
        </div>
        <div class="d-viz">
          <svg viewBox="0 0 200 190" xmlns="http://www.w3.org/2000/svg">
            <text x="100" y="16" font-size="11" font-weight="700" fill="#5d6878" text-anchor="middle">Mortalidad a 10 años</text>
            <rect x="40" y="34" width="48" height="96" rx="3" fill="#0a3d62" fill-opacity="0.12" stroke="#0a3d62" stroke-width="1.4"/>
            <rect x="40" y="40" width="48" height="90" fill="#0a3d62" fill-opacity="0.85"/>
            <rect x="112" y="34" width="48" height="96" rx="3" fill="#0f9aa0" fill-opacity="0.12" stroke="#0f9aa0" stroke-width="1.4"/>
            <rect x="112" y="44" width="48" height="86" fill="#0f9aa0" fill-opacity="0.85"/>
            <text x="64" y="120" font-size="14" font-weight="800" fill="#fff" text-anchor="middle">86%</text>
            <text x="136" y="120" font-size="14" font-weight="800" fill="#fff" text-anchor="middle">83%</text>
            <text x="64" y="148" font-size="11" font-weight="700" fill="#0a3d62" text-anchor="middle">TAVR</text>
            <text x="136" y="148" font-size="11" font-weight="700" fill="#0f9aa0" text-anchor="middle">Cirugía</text>
            <text x="100" y="172" font-size="9.5" fill="#8c97a6" text-anchor="middle">HR 1,13 (1,02-1,25)</text>
          </svg>
          <div style="text-align:center;font-size:10.5px;color:var(--gris);margin-top:-4px;">Reintervención 6,3% vs 1,6%</div>
        </div>
      </div>
    </div>
...
OUTDIR = "/Users/dmarzal/Documents/Claude/Briefing Cardiovascular/Briefing Cardiovascular_N2"
os.makedirs(OUTDIR, exist_ok=True)
with io.open(OUTDIR + "/Briefing Cardiovascular_N2.html","w",encoding="utf-8") as f:
    f.write(HTML)
