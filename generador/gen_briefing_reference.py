...
<style>
  ...
  *{{box-sizing:border-box;}}
  ...
  .sec-head .chev{{flex:0 0 auto;margin-left:auto;width:0;height:0;border-top:9px solid transparent;border-bottom:9px solid transparent;border-left:13px solid currentColor;font-size:0;transition:transform .18s ease;}}
