#!/usr/bin/env python3
# Elegibles N13 (31 ago - 6 sep 2026). Incluye INCLUSIÓN OBLIGATORIA sin abstract.
import json, os, re
D1, D2 = '2026/08/31', '2026/09/06'
BAD = {'Editorial','Comment','Letter','Published Erratum','News','Case Reports'}
B = os.path.dirname(os.path.abspath(__file__))
recs = json.load(open(B+'/n13_corpus.json'))['recs']
...
EL=DEDUP
json.dump(EL, open(B+'/n13_el.json','w'), ensure_ascii=False)
