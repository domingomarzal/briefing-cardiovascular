#!/usr/bin/env python3
# Fusiona metadatos (n14_sel.json) + textos de los 5 lotes (n14_dataN.json) -> n14_data.json
import json, os, glob
B = os.path.dirname(os.path.abspath(__file__))
SEL = {o['key']: o for o in json.load(open(B+'/n14_sel.json'))}
TXT = {}
for f in sorted(glob.glob(B+'/n14_data[0-4].json')):
...
json.dump(out, open(B+'/n14_data.json','w'), ensure_ascii=False, indent=1)
print(f"n14_data.json: {len(out)} fichas")
