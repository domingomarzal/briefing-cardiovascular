#!/usr/bin/env python3
# Selección y ponderación N14 (7 - 13 sep 2026).
...
EL = json.load(open(B + '/n14_el.json'))
...
cand, descartes = {}, {}
for f in sorted(glob.glob(B+'/n14_out?.json')):
...
json.dump(out, open(B+'/n14_sel.json','w'), ensure_ascii=False, indent=1)
json.dump({o['key']:o['acr'] for o in out if o['acr']}, open(B+'/n14_acr.json','w'), ensure_ascii=False, indent=1)
