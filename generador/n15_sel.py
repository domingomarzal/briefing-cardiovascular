#!/usr/bin/env python3
# Selección y ponderación N15 (14 - 20 sep 2026).
...
EL = json.load(open(B + '/n15_el.json'))
...
cand, descartes = {}, {}
for f in sorted(glob.glob(B+'/n15_out?.json')):
...
json.dump(out, open(B+'/n15_sel.json','w'), ensure_ascii=False, indent=1)
json.dump({o['key']:o['acr'] for o in out if o['acr']}, open(B+'/n15_acr.json','w'), ensure_ascii=False, indent=1)
