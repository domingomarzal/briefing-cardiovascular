URL="https://domingomarzal.github.io/briefing-cardiovascular/n1/"
...
<td style="font-size:13px;color:#c4d4df">UICAR · Quirónsalud</td>
<td align="right" style="font-size:13px;color:#c4d4df">N1 · 8 al 14 de junio de 2026</td>
</tr></table></td>
...
items=[
("Riesgo predicho y beneficio esperado en el síndrome CKM — Scientific Statement AHA/ACC (PREVENT)","J Am Coll Cardiol","10.1016/j.jacc.2026.05.007"),
("Hypertension (In the Clinic) — guías 2025","Ann Intern Med","10.7326/ANNALS-26-01311"),
("Elecoglipron, agonista oral del receptor GLP-1, en obesidad (VISTA)","Lancet","10.1016/S0140-6736(26)00748-8"),
]
rows=""
...
html=f'<div style="font-family:Arial,Helvetica,sans-serif;max-width:680px;margin:0 auto;color:#103a47">{banner}{dest}{ntp}<p style="margin:22px 0 0;font-size:12px;color:#7b8694">Briefing completo (10 secciones, 45 artículos): <a href="{URL}" style="color:#0f9aa0">{URL}</a></p></div>'
plain=f"""Briefing Cardiovascular — UICAR · Quirónsalud — N1 · 8 al 14 de junio de 2026.
Abrir el briefing: {URL}

DESTACADO: Guía CKM 2026 (AHA/ACC/ADA/ASN) — Circulation — {doi('10.1161/CIR.0000000000001453')}

NO TE LOS PUEDES PERDER:
1. Riesgo predicho y beneficio esperado en el síndrome CKM (PREVENT) — J Am Coll Cardiol — {doi('10.1016/j.jacc.2026.05.007')}
2. Hypertension (In the Clinic) — guías 2025 — Ann Intern Med — {doi('10.7326/ANNALS-26-01311')}
3. Elecoglipron, agonista oral GLP-1, en obesidad (VISTA) — Lancet — {doi('10.1016/S0140-6736(26)00748-8')}"""
import json
open("/tmp/n1_body.txt","w").write(plain)
open("/tmp/n1_htmlbody.html","w").write(html)
print(json.dumps({"ok":True,"htmllen":len(html)}))
print(plain)
